...
void initialiseNameMap() {
	...
	teamsByName["NPC_Luke"] = TEAM_PLAYER;
	teamsByName["NPC_MonMothma"] = TEAM_PLAYER;
	teamsByName["NPC_Rosh_Penin"] = TEAM_PLAYER;
	teamsByName["NPC_Tavion"] = TEAM_PLAYER;
	teamsByName["NPC_Tavion_New"] = TEAM_PLAYER;
	teamsByName["NPC_Alora"] = TEAM_PLAYER;
	teamsByName["NPC_Reelo"] = TEAM_PLAYER;
	teamsByName["NPC_Galak"] = TEAM_PLAYER;
	teamsByName["NPC_Desann"] = TEAM_PLAYER;
	teamsByName["NPC_Rax"] = TEAM_PLAYER;
	teamsByName["NPC_BobaFett"] = TEAM_PLAYER;
	teamsByName["NPC_Ragnos"] = TEAM_PLAYER;
	teamsByName["NPC_Lannik_Racto"] = TEAM_PLAYER;
	teamsByName["NPC_Kothos"] = TEAM_PLAYER;
	teamsByName["NPC_Chewbacca"] = TEAM_PLAYER;
	teamsByName["NPC_Bartender"] = TEAM_PLAYER;
	teamsByName["NPC_MorganKatarn"] = TEAM_PLAYER;
	teamsByName["NPC_Jedi"] = TEAM_PLAYER;
	teamsByName["NPC_Prisoner"] = TEAM_PLAYER;
	teamsByName["NPC_Merchant"] = TEAM_PLAYER;
	teamsByName["NPC_Rebel"] = TEAM_PLAYER;
	teamsByName["NPC_Human_Merc"] = TEAM_PLAYER;
	teamsByName["NPC_Stormtrooper"] = TEAM_PLAYER;
	teamsByName["NPC_StormtrooperOfficer"] = TEAM_PLAYER;
	teamsByName["NPC_Tie_Pilot"] = TEAM_PLAYER;
	teamsByName["NPC_Snowtrooper"] = TEAM_PLAYER;
	teamsByName["NPC_RocketTrooper"] = TEAM_PLAYER;
	teamsByName["NPC_HazardTrooper"] = TEAM_PLAYER;
	teamsByName["NPC_Ugnaught"] = TEAM_PLAYER;
	teamsByName["NPC_Jawa"] = TEAM_PLAYER;
	teamsByName["NPC_Gran"] = TEAM_PLAYER;
	teamsByName["NPC_Rodian"] = TEAM_PLAYER;
	teamsByName["NPC_Weequay"] = TEAM_PLAYER;
	teamsByName["NPC_Trandoshan"] = TEAM_PLAYER;
	teamsByName["NPC_Tusken"] = TEAM_PLAYER;
	teamsByName["NPC_Noghri"] = TEAM_PLAYER;
	teamsByName["NPC_SwampTrooper"] = TEAM_PLAYER;
	teamsByName["NPC_Imperial"] = TEAM_PLAYER;
	teamsByName["NPC_ImpWorker"] = TEAM_PLAYER;
	teamsByName["NPC_BespinCop"] = TEAM_PLAYER;
	teamsByName["NPC_Reborn"] = TEAM_PLAYER;
	teamsByName["NPC_Reborn_New"] = TEAM_PLAYER;
	teamsByName["NPC_Cultist"] = TEAM_PLAYER;
	teamsByName["NPC_Cultist_Saber"] = TEAM_PLAYER;
	teamsByName["NPC_Cultist_Saber_Powers"] = TEAM_PLAYER;
	teamsByName["NPC_Cultist_Destroyer"] = TEAM_PLAYER;
	teamsByName["NPC_Cultist_Commando"] = TEAM_PLAYER;
	teamsByName["NPC_ShadowTrooper"] = TEAM_PLAYER;
	teamsByName["NPC_Saboteur"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Murjj"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Swamp"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Howler"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Rancor"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Mutant_Rancor"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Wampa"] = TEAM_PLAYER;
	teamsByName["NPC_MineMonster"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Claw"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Glider"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Flier2"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Lizard"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Fish"] = TEAM_PLAYER;
	teamsByName["NPC_Monster_Sand_Creature"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Interrogator"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Probe"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Mark1"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Mark2"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_ATST"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Seeker"] =  TEAM_PLAYER;
	teamsByName["NPC_Droid_Remote"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Sentry"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Gonk"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Mouse"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_R2D2"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_R5D2"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Protocol"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Assassin"] = TEAM_PLAYER;
	teamsByName["NPC_Droid_Saber"] = TEAM_PLAYER;
	teamsByName["NPC_Colombian_Soldier"] = TEAM_PLAYER;
	teamsByName["NPC_Colombian_Rebel"] = TEAM_PLAYER;
	teamsByName["NPC_Colombian_EmplacedGunner"] = TEAM_PLAYER;
	teamsByName["NPC_Manuel_Vergara_RMG"] = TEAM_PLAYER;
