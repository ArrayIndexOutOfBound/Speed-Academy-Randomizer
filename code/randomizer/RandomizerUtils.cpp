...
void initialiseNameMap() {
	...
	teamsByName["NPC_Tavion_New"] = TEAM_ENEMY;
	teamsByName["NPC_Alora"] = TEAM_ENEMY;
	teamsByName["NPC_Reelo"] = TEAM_ENEMY;
	teamsByName["NPC_Galak"] = TEAM_ENEMY;
	teamsByName["NPC_Desann"] = TEAM_ENEMY;
	teamsByName["NPC_Rax"] = TEAM_ENEMY;
	teamsByName["NPC_BobaFett"] = TEAM_ENEMY;
	teamsByName["NPC_Ragnos"] = TEAM_ENEMY;
	teamsByName["NPC_Lannik_Racto"] = TEAM_ENEMY;
	teamsByName["NPC_Kothos"] = TEAM_ENEMY;
	teamsByName["NPC_Chewbacca"] = TEAM_PLAYER;
	teamsByName["NPC_Bartender"] = TEAM_NEUTRAL;
	...
	teamsByName["NPC_Human_Merc"] = TEAM_ENEMY;
	...
	teamsByName["NPC_Snowtrooper"] = TEAM_ENEMY;
	teamsByName["NPC_RocketTrooper"] = TEAM_ENEMY;
	teamsByName["NPC_HazardTrooper"] = TEAM_ENEMY;
	teamsByName["NPC_Ugnaught"] = TEAM_ENEMY;
	teamsByName["NPC_Jawa"] = TEAM_NEUTRAL;
	...
	teamsByName["NPC_Tusken"] = TEAM_ENEMY;
	teamsByName["NPC_Noghri"] = TEAM_ENEMY;
	teamsByName["NPC_SwampTrooper"] = TEAM_ENEMY;
	teamsByName["NPC_Imperial"] = TEAM_ENEMY;
	teamsByName["NPC_ImpWorker"] = TEAM_ENEMY;
	teamsByName["NPC_BespinCop"] = TEAM_ENEMY;
	teamsByName["NPC_Reborn"] = TEAM_ENEMY;
	teamsByName["NPC_Reborn_New"] = TEAM_ENEMY;
	teamsByName["NPC_Cultist"] = TEAM_ENEMY;
	teamsByName["NPC_Cultist_Saber"] = TEAM_ENEMY;
	teamsByName["NPC_Cultist_Saber_Powers"] = TEAM_ENEMY;
	teamsByName["NPC_Cultist_Destroyer"] = TEAM_ENEMY;
	teamsByName["NPC_Cultist_Commando"] = TEAM_ENEMY;
	teamsByName["NPC_ShadowTrooper"] = TEAM_ENEMY;
	teamsByName["NPC_Saboteur"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Murjj"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Swamp"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Howler"] = TEAM_FREE;
	teamsByName["NPC_Monster_Rancor"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Mutant_Rancor"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Wampa"] = TEAM_ENEMY;
	teamsByName["NPC_MineMonster"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Claw"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Glider"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Flier2"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Lizard"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Fish"] = TEAM_ENEMY;
	teamsByName["NPC_Monster_Sand_Creature"] = TEAM_ENEMY;
	teamsByName["NPC_Droid_Interrogator"] = TEAM_ENEMY;
	teamsByName["NPC_Droid_Probe"] = TEAM_ENEMY;
	teamsByName["NPC_Droid_Mark1"] = TEAM_ENEMY;
	teamsByName["NPC_Droid_Mark2"] = TEAM_ENEMY;
	...
	teamsByName["NPC_Colombian_Soldier"] = TEAM_ENEMY;
	teamsByName["NPC_Colombian_Rebel"] = TEAM_ENEMY;
	teamsByName["NPC_Colombian_EmplacedGunner"] = TEAM_ENEMY;
	teamsByName["NPC_Manuel_Vergara_RMG"] = TEAM_ENEMY;
...
void initialiseMapByClass() {
	...
	teamsByClass[CLASS_CLAW] = TEAM_ENEMY;
	teamsByClass[CLASS_COMMANDO] = TEAM_ENEMY;
	teamsByClass[CLASS_DESANN] = TEAM_ENEMY;
	teamsByClass[CLASS_FISH] = TEAM_ENEMY;
	teamsByClass[CLASS_FLIER2] = TEAM_ENEMY;
	teamsByClass[CLASS_GALAK] = TEAM_ENEMY;
	teamsByClass[CLASS_GLIDER] = TEAM_ENEMY;
	teamsByClass[CLASS_GONK] = TEAM_ENEMY;
	teamsByClass[CLASS_GRAN] = TEAM_ENEMY;
	teamsByClass[CLASS_HOWLER] = TEAM_FREE;
	teamsByClass[CLASS_RANCOR] = TEAM_ENEMY;
	teamsByClass[CLASS_SAND_CREATURE] = TEAM_ENEMY;
	teamsByClass[CLASS_WAMPA] = TEAM_ENEMY;
	...
	teamsByClass[CLASS_LIZARD] = TEAM_ENEMY;
	teamsByClass[CLASS_LUKE] = TEAM_PLAYER;
	teamsByClass[CLASS_MARK1] = TEAM_ENEMY;
	teamsByClass[CLASS_MARK2] = TEAM_ENEMY;
	...
	teamsByClass[CLASS_MURJJ] = TEAM_ENEMY;
	...
	teamsByClass[CLASS_SABOTEUR] = TEAM_ENEMY;
	teamsByClass[CLASS_STORMTROOPER] = TEAM_ENEMY;
	teamsByClass[CLASS_SWAMP] = TEAM_ENEMY;
	teamsByClass[CLASS_SWAMPTROOPER] = TEAM_ENEMY;
	teamsByClass[CLASS_NOGHRI] = TEAM_ENEMY;
	teamsByClass[CLASS_TAVION] = TEAM_ENEMY;
	teamsByClass[CLASS_ALORA] = TEAM_ENEMY;
	teamsByClass[CLASS_TRANDOSHAN] = TEAM_ENEMY;
	teamsByClass[CLASS_UGNAUGHT] = TEAM_ENEMY;
	teamsByClass[CLASS_JAWA] = TEAM_NEUTRAL;
	teamsByClass[CLASS_WEEQUAY] = TEAM_ENEMY;
	teamsByClass[CLASS_TUSKEN] = TEAM_ENEMY;
	teamsByClass[CLASS_BOBAFETT] = TEAM_ENEMY;
	teamsByClass[CLASS_ROCKETTROOPER] = TEAM_ENEMY;
	teamsByClass[CLASS_SABER_DROID] = TEAM_ENEMY;
	teamsByClass[CLASS_ASSASSIN_DROID] = TEAM_ENEMY;
	teamsByClass[CLASS_HAZARD_TROOPER] = TEAM_ENEMY;
	teamsByClass[CLASS_VEHICLE] = TEAM_ENEMY;
}
